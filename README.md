...
- Press `M` for the Mixer: live stereo separation, Amiga resampler, interpolation, volume ramping, tempo, pitch, gain and loop settings, all applied by libopenmpt on the fly and remembered between sessions
